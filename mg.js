...
function MG(ob, w, h) {
	...
	this.w = w || 10;
	this.h = h || 10;
	this.grid_size = 72;		// 迷宫格子宽度，暂时没有用
...
MG.prototype = {
	...
	_showByCanvas: function () {
		...
		finish_img.src = "http://diggirl-gadget.googlecode.com/svn/trunk/finish.gif";
...
MG.border = function (ob, v) {
	...
	if (v & 1)
		ob.style.borderTop = "solid 3px #f5f5f5";
	if (v & 2)
		ob.style.borderRight = "solid 3px #f5f5f5";
	if (v & 4)
		ob.style.borderBottom = "solid 3px #f5f5f5";
	if (v & 8)
		ob.style.borderLeft = "solid 3px #f5f5f5";
};
...
function MG_Me(mg) {
	...
	this.finished = false;
	this.emotions = {
		normal: "http://diggirl-gadget.googlecode.com/svn/trunk/mumu.gif",
		happy: "http://diggirl-gadget.googlecode.com/svn/trunk/mumu_happy.gif",
		unhappy: "http://diggirl-gadget.googlecode.com/svn/trunk/mumu_unhappy.gif",
		surprised: "http://diggirl-gadget.googlecode.com/svn/trunk/mumu_surprised.gif",
		tongue: "http://diggirl-gadget.googlecode.com/svn/trunk/me_tongue.gif"
	};
...
MG_Me.prototype = {
	init: function () {
		...
		tmp_img.setAttribute("src", "http://diggirl-gadget.googlecode.com/svn/trunk/mumu.gif");
		this.me_img = tmp_img;
		...
		$.hotkeys.add("up", function () {_this.move(0);} );
		$.hotkeys.add("right", function () {_this.move(1);} );
		$.hotkeys.add("down", function () {_this.move(2);} );
		$.hotkeys.add("left", function () {_this.move(3);} );
		$.hotkeys.add("w", function () {_this.move(0);} );
